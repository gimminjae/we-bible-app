...
const messages = {
  ko: {
    ...
    mypage: {
      ...
      pointGuideTitle: '포인트 기능 안내',
      pointGuideColorChange: '100P를 사용해서 성경 잔디 색상을 변경할 수 있어요.',
      pointGuideFillPast:
        '100P를 사용해서 지난 날짜의 잔디를 채울 수 있어요.',
    ...
    grass: {
      ...
      fillButton: '잔디 채우기 (100P)',
      fillTitle: '잔디 채우기',
      fillConfirm: '100P를 사용하여 잔디를 채우시겠어요?',
      fillCancel: '취소',
      fillProceed: '채우기',
      fillNeedPoint: '포인트가 부족해요. (100P 필요)',
      fillSuccess: '포인트를 소모하여 잔디를 채웠어요!',
      filledByPointHistory: '포인트를 소모하여 잔디를 채웠어요!',
      noDataYet: '아직 읽은 기록이 없어요',
      daySuffix: '일',
      selectYear: '연도 선택',
      less: '적음',
      more: '많음',
      changeColorButton: '색상 변경 (100P)',
      changeColorTitle: '잔디 색상 변경',
      changeColorConfirm: '색상을 변경하시겠어요?',
      changeColorCancel: '취소',
      changeColorProceed: '변경',
      changeColorCost: '색상 변경 시 100포인트가 차감됩니다.',
      colorChanged: '잔디 색상이 변경되었어요!',
      colorChangedTo: '{color}색으로 변경됐어요!',
      colorChangeNeedPoint: '포인트가 부족해요. (100P 필요)',
      currentColor: '사용중',
      color: {
        green: '초록',
        yellow: '노랑',
  ...
  en: {
    ...
    mypage: {
      ...
      pointGuideTitle: 'Point Guide',
      pointGuideColorChange: 'You can spend 100P to change Bible grass color.',
      pointGuideFillPast:
        'You can spend 100P to fill grass for past dates.',
    ...
    grass: {
      ...
      fillButton: 'Fill grass (100P)',
      fillTitle: 'Fill grass',
      fillConfirm: 'Do you want to spend 100P to fill this grass?',
      fillCancel: 'Cancel',
      fillProceed: 'Fill',
      fillNeedPoint: 'Not enough points. (100P required)',
      fillSuccess: 'You filled this grass by spending points!',
      filledByPointHistory: 'You filled this grass by spending points!',
      noDataYet: 'No reading recorded yet',
      daySuffix: '',
      selectYear: 'Select year',
      less: 'Less',
      more: 'More',
      changeColorButton: 'Change color (100P)',
      changeColorTitle: 'Change grass color',
      changeColorConfirm: 'Do you want to change the color?',
      changeColorCancel: 'Cancel',
      changeColorProceed: 'Change',
      changeColorCost: 'Changing color costs 100 points.',
      colorChanged: 'Grass color changed!',
      colorChangedTo: 'Changed to {color}!',
      colorChangeNeedPoint: 'Not enough points. (100P required)',
