...
alter table public.plans add column if not exists plan_description text not null default '';
...
create table if not exists public.churches (
  ...
  image_url text,
  shared_plan_ranking_public boolean not null default true,
  shared_plan_progress_public boolean not null default true,
  created_at timestamptz not null default timezone('utc', now()),
  updated_at timestamptz not null default timezone('utc', now()),
...
alter table public.churches add column if not exists description text not null default '';
alter table public.churches add column if not exists image_url text;
alter table public.churches add column if not exists shared_plan_ranking_public boolean not null default true;
alter table public.churches add column if not exists shared_plan_progress_public boolean not null default true;
...
create table if not exists public.prayers (
  ...
  user_id uuid not null references auth.users (id) on delete cascade,
  client_id text,
  is_my_prayer boolean not null default false,
  requester text not null default '',
  relation varchar(50) not null default '',
  target text not null default '',
  created_at text not null default ''
